...
import { getBlogPostBySlug } from '@/application/blog';
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    title: `Blog - ${slug}`,
    description: `Read the blog post titled "${slug}"`,
  };
}
        ...
        <main className="flex w-full flex-col pt-4 pb-12">
          <ReactMarkdown
            components={{
              ...
              h2: ({ ...props }) => <h2 className="text-2xl font-semibold mt-4" {...props} />,
              h3: ({ ...props }) => <h3 className="text-xl font-semibold mt-4" {...props} />,
              h4: ({ ...props }) => <h4 className="text-xl font-semibold mt-4" {...props} />,
